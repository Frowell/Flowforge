...
down_revision: Union[str, None] = '92284ff9b280'
...
def upgrade() -> None:
    ...
    audit_action = postgresql.ENUM(
        'CREATED', 'UPDATED', 'DELETED', 'EXECUTED', 'REVOKED',
        name='audit_action',
        create_type=False
    )
    ...
    op.create_table('audit_logs',
        ...
        sa.Column('action', sa.Enum('CREATED', 'UPDATED', 'DELETED', 'EXECUTED', 'REVOKED', name='audit_action'), nullable=False),
        sa.Column('resource_type', sa.Enum('WORKFLOW', 'DASHBOARD', 'WIDGET', 'API_KEY', name='audit_resource_type'), nullable=False),
