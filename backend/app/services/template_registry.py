...
TEMPLATES: dict[str, TemplateDefinition] = {
    "realtime-position-monitor": TemplateDefinition(
        ...
        description=(
            "Monitor positions grouped by symbol with aggregated"
            " quantities. Includes a bar chart and KPI card output."
        ),
        category="Trading",
    ...
    "vwap-analysis": TemplateDefinition(
        ...
        name="VWAP Analysis",
        description=(
            "Calculate volume-weighted average price from trade"
            " data with time-windowed grouping and candlestick"
            " visualization."
        ),
        category="Analytics",
        ...
        graph_json={
            "nodes": [
                _make_node(
                    ...
                    0,
                    0,
                    {"table": "trades", "freshness": "analytical"},
                ),
                _make_node(
                    "fm1",
                    "formula",
    ...
    "sector-exposure": TemplateDefinition(
        ...
        description=(
            "Join positions with instrument metadata and"
            " visualize exposure by sector as a bar chart."
        ),
        category="Risk",
        ...
        graph_json={
            "nodes": [
                ...
                _make_node(
                    ...
                    0,
                    200,
                    {"table": "instruments", "freshness": "analytical"},
                ),
                _make_node(
                    "jn1",
                    "join",
    ...
    "trade-blotter": TemplateDefinition(
        ...
        name="Trade Blotter",
        description=(
            "Live trade blotter with date filtering, sorted by"
            " most recent trades. Outputs to a table view."
        ),
        category="Trading",
        ...
        graph_json={
            "nodes": [
                _make_node(
                    ...
                    0,
                    0,
                    {"table": "trades", "freshness": "realtime"},
                ),
                _make_node(
                    "ft1",
                    "filter",
                ...
                _make_node(
                    ...
                    600,
                    0,
                    {"sort_columns": [{"column": "trade_time", "direction": "desc"}]},
                ),
                _make_node(
                    "tbl1", "table_output", "Trade Table", 900, 0, {"page_size": 50}
                ),
            ],
            "edges": [
                _make_edge("ds1", "ft1"),
    ...
    "pnl-dashboard": TemplateDefinition(
        ...
        name="P&L Dashboard",
        description=(
            "Calculate unrealized P&L from positions and display"
            " via KPI card and line chart over time."
        ),
        category="Analytics",
        ...
        graph_json={
            "nodes": [
                ...
                _make_node(
                    ...
                    0,
                    {
                        "expression": "([current_price] - [avg_cost]) * [quantity]",
                        "output_column": "unrealized_pnl",
                    },
                ),
                _make_node(
                    "kpi1",
...
def instantiate_template(
    ...
    """Create a fresh copy of a template's graph_json with new UUIDs."""
